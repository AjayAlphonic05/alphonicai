            ...
            <div class="nav-wrapper">
                ...
                <ul class="nav-menu">
                    ...
                    <li class="has-mega-menu">
                        <a href="<?=_APPLICATION_URL;?>services.php" class="<?php echo ($current_page == 'services') ? 'active' : ''; ?>">Services</a>
                        <div class="mega-menu">
                            <div class="container">
                                <div class="mega-menu-content">
                                    <div class="mega-menu-column">
                                        <h4>Development</h4>
                                        <a href="<?=_APPLICATION_URL;?>services/custom-software-development.php" class="mega-menu-link">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/web-development.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/mobile-app-development.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/api-development.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/ecommerce-solutions.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                    ...
                                    <div class="mega-menu-column">
                                        <h4>AI & Data</h4>
                                        <a href="<?=_APPLICATION_URL;?>services/ai-ml-solutions.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/chatbot-development.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/data-analytics.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/computer-vision.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/nlp-solutions.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                    ...
                                    <div class="mega-menu-column">
                                        <h4>Cloud & DevOps</h4>
                                        <a href="<?=_APPLICATION_URL;?>services/cloud-solutions.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/devops-services.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/cloud-migration.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/microservices.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                    ...
                                    <div class="mega-menu-column">
                                        <h4>Enterprise</h4>
                                        <a href="<?=_APPLICATION_URL;?>services/enterprise-software.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/saas-development.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/blockchain-development.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/ui-ux-design.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                                        ...
                                        <a href="<?=_APPLICATION_URL;?>services/maintenance-support.php" class="mega-menu-link">
                                            <div class="mega-menu-icon">
                    ...
                    <li><a href="<?=_APPLICATION_URL;?>about.php" class="<?php echo ($current_page == 'about') ? 'active' : ''; ?>">About</a></li>
                    <li><a href="<?=_APPLICATION_URL;?>contact.php" class="cta-btn <?php echo ($current_page == 'contact') ? 'active' : ''; ?>">Contact Us</a></li>
                </ul>
            </div>
        </div>
    </nav>
